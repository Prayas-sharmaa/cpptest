...
class CreateOrderForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['recipe'].choices = [(r["recipe_id"], r.get("name", r["recipe_id"])) for r in recipes]
...
class RecipeForm(forms.Form):
    ...
    ingredients = forms.CharField(max_length=500, help_text="Format: item1:qty1,item2:qty2")
